...
public   class parkingSpot {
   ...
   // https://lamp.ms.wits.ac.za/home/s2683067/getspot.php?table=ThirdYearParking
    public void findspot ( String parkinglot , String action,Dashboard a) {
        fetch data= new fetch();
        ...
        data.getdata(a, urlprefixgsp+parkinglot, new requesthandler() {
            ...
            public void processresponse(String responce) {
                ...
                if(action.equals("bookspot")){
                    ...
                    parkingSpot.this.changestate(parkinglot,"bookspot",spot,a);
                   ...
                   parkingSpot.this.changestate(parkinglot,"reservespot",spot,a);
    ...
    public void freespot(String parkinglot,String spot,Dashboard a){

        this.changestate(parkinglot,"empty",spot,a);
        coordinates=null;
        spot=null;
    }
